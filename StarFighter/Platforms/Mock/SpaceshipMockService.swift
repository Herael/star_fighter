...
class SpaceshipMockService: SpaceshipService {
    ...
    private let spaceships: [Spaceship] = [
        Spaceship(id: "1", name: "Executor", model: "Executor-class star dreadnought", manufacturer: "Kuat Drive Yards, Fondor Shipyards", speed: 4, hp: 600000, damage: 100000, spaceshipClass: "Star dreadnought" ,img: URL(string: "https://vignette.wikia.nocookie.net/spore/images/4/46/Executor-class_Star_Dreadnought.png/revision/latest/scale-to-width-down/1000?cb=20161018175227")),
        
        Spaceship(id: "2", name: "Sentinel-class landing craft", model: "Sentinel-class landing craft", manufacturer: "Sienar Fleet Systems, Cyngus Spaceworks", speed: 110, hp: 54000, damage: 8000, spaceshipClass: "landing craft", img: URL(string: "https://vignette.wikia.nocookie.net/starwars/images/6/6e/Sentinel_negvv.png/revision/latest?cb=20170411232732"))
    ]
